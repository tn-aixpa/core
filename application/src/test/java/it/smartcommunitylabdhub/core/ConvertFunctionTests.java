...
class ConvertFunctionTests {
    ...
    void testReverse() {
        ...
        String output = ConversionUtils.reverse(input, "integer");
    ...
    void testListConvert() {
        ...
        List<Integer> integers = (List<Integer>) ConversionUtils.convertIterable(strings, "integer", Integer.class);
    ...
    void testListRevert() {
        ...
        List<String> strings = (List<String>) ConversionUtils.reverseIterable(integers, "integer", String.class);
