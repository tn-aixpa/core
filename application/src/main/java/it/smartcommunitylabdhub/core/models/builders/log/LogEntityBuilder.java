    ...
    return EntityFactory.combine(
      ...
      builder ->
        builder
          ...
          .with(l ->
            l.setMetadata(
              ConversionUtils.convert(logDTO.getMetadata(), "metadata")
            )
          )
          .with(l ->
            l.setExtra(ConversionUtils.convert(logDTO.getExtra(), "cbor"))
          )
          .with(l ->
            l.setBody(ConversionUtils.convert(logDTO.getBody(), "cbor"))
          )
          .with(l ->
            l.setStatus(ConversionUtils.convert(logDTO.getStatus(), "cbor"))
          )
          ...
          .withIf(
            logDTO.getMetadata().getRun() != null,
            l -> l.setRun(logDTO.getMetadata().getRun())
          )
          .withIf(
    ...
    return EntityFactory.combine(
      ...
      builder ->
        builder
          ...
          .withIf(
            newLog.getProject() != null,
            l -> l.setProject(newLog.getProject())
          )
          .withIf(
            newLog.getCreated() != null,
            l -> l.setCreated(newLog.getCreated())
          )
          .withIf(
            newLog.getUpdated() != null,
            l -> l.setUpdated(newLog.getUpdated())
          )
    );
  }
}
