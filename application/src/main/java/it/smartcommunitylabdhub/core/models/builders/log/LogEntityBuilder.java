    ...
    public LogEntity build(Log logDTO) {
        ...
        return EntityFactory.combine(
            ...
            builder ->
                builder
                    // check id
                    .withIf(logDTO.getId() != null, l -> l.setId(logDTO.getId()))
                    .with(l -> l.setMetadata(ConversionUtils.convert(logDTO.getMetadata(), "metadata")))
                    .with(l -> l.setExtra(ConversionUtils.convert(logDTO.getExtra(), "cbor")))
                    .with(l -> l.setBody(ConversionUtils.convert(logDTO.getBody(), "cbor")))
                    ...
                    .withIf(logDTO.getMetadata().getRun() != null, l -> l.setRun(logDTO.getMetadata().getRun()))
                    .withIf(
                        logDTO.getMetadata().getProject() != null,
                        l -> l.setProject(logDTO.getMetadata().getProject())
                    )
                    .withIf(
                        logDTO.getMetadata().getCreated() != null,
                        l -> l.setCreated(logDTO.getMetadata().getCreated())
                    )
                    .withIf(
                        logDTO.getMetadata().getUpdated() != null,
                        l -> l.setUpdated(logDTO.getMetadata().getUpdated())
                    )
        );
    }
        ...
        return EntityFactory.combine(
            ...
            builder ->
                builder
                    ...
                    .withIf(newLog.getRun() != null, l -> l.setRun(newLog.getRun()))
                    .withIf(newLog.getProject() != null, l -> l.setProject(newLog.getProject()))
                    .withIf(newLog.getCreated() != null, l -> l.setCreated(newLog.getCreated()))
                    .withIf(newLog.getUpdated() != null, l -> l.setUpdated(newLog.getUpdated()))
        );
    }
}
