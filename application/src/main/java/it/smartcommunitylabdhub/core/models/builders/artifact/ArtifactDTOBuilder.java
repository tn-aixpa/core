                ...
                builder
                    ...
                    .with(dto -> {
                        ...
                        ArtifactMetadata artifactMetadata = Optional
                            .ofNullable(
                                metadataConverter.reverseByClass(artifact.getMetadata(), ArtifactMetadata.class)
                            )
                    ...
                    .withIfElse(
                        ...
                        (dto, condition) ->
                            Optional
                                ...
                                .ifPresent(embedded -> dto.setSpec(ConversionUtils.reverse(artifact.getSpec(), "cbor")))
                    )
                    .withIfElse(
                        embeddable,
                        (dto, condition) ->
                            Optional
                                ...
                                .filter(embedded -> !condition || embedded)
                                .ifPresent(embedded ->
                                    dto.setExtra(ConversionUtils.reverse(artifact.getExtra(), "cbor"))
                                )
                    )
                    .withIfElse(
                        embeddable,
