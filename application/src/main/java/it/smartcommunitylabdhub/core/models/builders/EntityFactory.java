...
public class EntityFactory {
    ...
    public static <T, U> T create(Supplier<T> entitySupplier, Consumer<EntityBuilder<T, U>> buildFunction) {
        EntityBuilder<T, U> builder = new EntityBuilder<>(entitySupplier);
        buildFunction.accept(builder);
        return builder.build();
    }

    public static <T, U> T combine(T sourceEntity, Consumer<EntityBuilder<T, U>> buildFunction) {
