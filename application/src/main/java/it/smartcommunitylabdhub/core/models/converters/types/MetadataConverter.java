...
public class MetadataConverter<M extends BaseMetadata>
  ...
  public byte[] convert(M metadata) throws CustomException {
    try {
      ...
      Map<String, Object> metadataMap =
        JacksonMapper.OBJECT_MAPPER.convertValue(metadata, Map.class);
  ...
  @Override
  public <C> C reverseByClass(byte[] cborBytes, Class<C> targetClass)
    ...
    try {
      ...
      Map<String, Object> cborMap = JacksonMapper.CBOR_OBJECT_MAPPER.readValue(
        cborBytes,
        HashMap.class
      );
  ...
  public M reverseConvert(byte[] cborBytes) throws CustomException {
    throw new UnsupportedOperationException(
      "reverseConvert method not implemented." +
