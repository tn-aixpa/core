        ...
        return EntityFactory.combine(
            ...
            builder ->
                builder
                    ...
                    .with(p -> p.setMetadata(ConversionUtils.convert(projectDTO.getMetadata(), "metadata")))
                    .with(p -> p.setExtra(ConversionUtils.convert(projectDTO.getExtra(), "cbor")))
                    .with(p -> p.setStatus(ConversionUtils.convert(projectDTO.getStatus(), "cbor")))
                    .with(p -> {
        ...
        return EntityFactory.combine(
            ...
            builder ->
                builder
                    ...
                    .withIf(newProject.getSource() != null, p -> p.setSource(newProject.getSource()))
                    .withIf(newProject.getDescription() != null, p -> p.setDescription(newProject.getDescription()))
        );
    }
}
