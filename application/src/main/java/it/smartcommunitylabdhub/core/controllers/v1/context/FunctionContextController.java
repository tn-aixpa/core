...
@Validated
@Tag(
  name = "Function context API",
  description = "Endpoints related to functions management in Context"
)
public class FunctionContextController extends AbstractContextController {
  ...
  public ResponseEntity<Page<Function>> getLatestFunctions(
    ...
    return ResponseEntity.ok(
      this.functionContextService.getLatestByProjectName(
          filter,
          project,
          pageable
        )
  ...
  public ResponseEntity<Page<Function>> getAllFunctions(
    ...
    return ResponseEntity.ok(
      this.functionContextService.getByProjectNameAndFunctionName(
          filter,
          project,
          name,
          pageable
  ...
  public ResponseEntity<Function> getFunctionByUuid(
    ...
    return ResponseEntity.ok(
      this.functionContextService.getByProjectAndFunctionAndUuid(
          project,
          name,
          uuid
        )
  ...
  public ResponseEntity<Function> getLatestFunctionByName(
    ...
    return ResponseEntity.ok(
      this.functionContextService.getLatestByProjectNameAndFunctionName(
          project,
          name
        )
    );
  ...
  public ResponseEntity<Function> createOrUpdateFunction(
    ...
    return ResponseEntity.ok(
      this.functionContextService.createOrUpdateFunction(
          project,
          name,
          functionDTO
        )
  ...
  public ResponseEntity<Function> updateUpdateFunction(
    ...
    return ResponseEntity.ok(
      this.functionContextService.updateFunction(
          project,
          name,
          uuid,
          functionDTO
  ...
  public ResponseEntity<Boolean> deleteSpecificFunctionVersion(
    ...
    // Remove Task
    List<Task> taskList =
      this.taskService.getTasksByFunction(TaskUtils.buildTaskString(function));
    ...
    return ResponseEntity.ok(
      this.functionContextService.deleteSpecificFunctionVersion(
          project,
          name,
          uuid
        )
  ...
  public ResponseEntity<Boolean> deleteFunction(
    ...
    this.functionContextService.listByProjectNameAndFunctionName(project, name)
      .forEach(function -> {
        // Remove Task
        List<Task> taskList =
          this.taskService.getTasksByFunction(
    ...
    return ResponseEntity.ok(
      this.functionContextService.deleteAllFunctionVersions(project, name)
    );
  }
}
