...
@Tag(
  name = "Task base API",
  description = "Endpoints related to tasks management out of the Context"
)
public class TaskController {
  ...
  @Operation(
    ...
    description = "Given a uuid return a specific task"
  )
  ...
  @Operation(
    ...
    description = "Create and return a new task"
  )
  @PostMapping(
    path = "",
  ...
  @Operation(
    ...
    description = "Update and return a task"
  )
  @PutMapping(
    path = "/{uuid}",
    consumes = { MediaType.APPLICATION_JSON_VALUE, "application/x-yaml" },
