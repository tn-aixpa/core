...
@Validated
@Tag(
  name = "Run context API",
  description = "Endpoints related to runs management in Context"
)
public class RunContextController extends AbstractContextController {
  ...
  public ResponseEntity<Page<Run>> getLatestRuns(
    ...
    return ResponseEntity.ok(
      this.RunContextService.getAllRunsByProjectName(filter, project, pageable)
    );
  }
  ...
  public ResponseEntity<Run> getRunByUuid(
    ...
    return ResponseEntity.ok(
      this.RunContextService.getByProjectAndRunUuid(project, uuid)
    );
  }
  ...
  public ResponseEntity<Run> updateUpdateRun(
    ...
    return ResponseEntity.ok(
      this.RunContextService.updateRun(project, uuid, RunDTO)
    );
  }
  ...
  public ResponseEntity<Boolean> deleteSpecificRunVersion(
    ...
    return ResponseEntity.ok(
      this.RunContextService.deleteSpecificRunVersion(project, uuid)
    );
  }
}
