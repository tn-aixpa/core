...
@Tag(
  name = "Run base API",
  description = "Endpoints related to runs management out of the Context"
)
public class RunController {
  ...
  @Operation(
    summary = "Get a run",
    description = "Given an uuid return the related Run"
  )
  ...
  @Operation(
    ...
    description = "Return the log list for a specific run"
  )
  @GetMapping(
    path = "/{uuid}/log",
  ...
  @Operation(
    summary = "Update specific run",
    description = "Update and return the update run"
  )
  @PutMapping(
    path = "/{uuid}",
    consumes = { MediaType.APPLICATION_JSON_VALUE, "application/x-yaml" },
