...
@Validated
@Tag(
  name = "DataItem base API",
  description = "Endpoints related to dataitems management out of the Context"
)
public class DataItemController {
  ...
  @Operation(
    summary = "List dataItems",
    description = "Return a list of all dataItems"
  )
  ...
  public ResponseEntity<Page<DataItem>> getDataItems(
    ...
    return ResponseEntity.ok(
      this.dataItemService.getDataItems(filter, pageable)
    );
  }

  @Operation(
    summary = "Create dataItem",
    description = "Create an dataItem and return"
  )
  @PostMapping(
    value = "",
  ...
  @Operation(
    summary = "Get a dataItem by uuid",
    description = "Return an dataItem"
  )
  ...
  @Operation(
    summary = "Update specific dataItem",
    description = "Update and return the dataItem"
  )
  @PutMapping(
    path = "/{uuid}",
    consumes = { MediaType.APPLICATION_JSON_VALUE, "application/x-yaml" },
  ...
  public ResponseEntity<DataItem> updateDataItem(
    ...
    return ResponseEntity.ok(
      this.dataItemService.updateDataItem(dataItemDTO, uuid)
    );
  }

  @Operation(
    summary = "Delete a dataItem",
    description = "Delete a specific dataItem"
  )
