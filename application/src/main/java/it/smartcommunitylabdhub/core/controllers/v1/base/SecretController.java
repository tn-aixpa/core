...
@ApiVersion("v1")
@Tag(
  name = "Secret base API",
  description = "Endpoints related to secret management out of the Context"
)
public class SecretController {
  ...
  @Operation(
    summary = "Get specific secret",
    description = "Given a uuid return a specific secret"
  )
  ...
  @Operation(
    ...
    description = "Create and return a new secret"
  )
  @PostMapping(
    path = "",
  ...
  @Operation(
    ...
    description = "Update and return a secret"
  )
  @PutMapping(
    path = "/{uuid}",
    consumes = { MediaType.APPLICATION_JSON_VALUE, "application/x-yaml" },
  ...
  public ResponseEntity<Secret> updateSecret(
    ...
    return ResponseEntity.ok(
      this.secretService.updateProjectSecret(functionDTO, uuid)
    );
  }
