...
public class ArtifactContextController extends AbstractContextController {
    ...
    public ResponseEntity<Page<Artifact>> getLatestArtifacts(
        ...
        return ResponseEntity.ok(this.artifactContextService.getLatestByProjectName(filter, project, pageable));
    }
    ...
    public ResponseEntity<Page<Artifact>> getAllArtifacts(
        ...
        return ResponseEntity.ok(
                this.artifactContextService.getByProjectNameAndArtifactName(filter, project, name, pageable)
        );
    }
    ...
    public ResponseEntity<Artifact> getArtifactByUuid(
        ...
        return ResponseEntity.ok(this.artifactContextService.getByProjectAndArtifactAndUuid(project, name, uuid));
    }
    ...
    public ResponseEntity<Artifact> getLatestArtifactByName(
        ...
        return ResponseEntity.ok(this.artifactContextService.getLatestByProjectNameAndArtifactName(project, name));
    }
