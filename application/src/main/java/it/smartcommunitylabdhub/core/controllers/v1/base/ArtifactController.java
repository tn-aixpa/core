...
@Validated
@Tag(
  name = "Artifact base API",
  description = "Endpoints related to artifacts management out of the Context"
)
public class ArtifactController {
  ...
  @Operation(
    ...
    description = "Return a list of all artifacts"
  )
  ...
  public ResponseEntity<Page<Artifact>> getArtifacts(
    ...
    return ResponseEntity.ok(
      this.artifactService.getArtifacts(filter, pageable)
    );
  }

  @Operation(
    summary = "Create artifact",
    description = "Create an artifact and return"
  )
  @PostMapping(
    value = "",
  ...
  @Operation(
    summary = "Get an artifact by uuid",
  ...
  @Operation(
    summary = "Update specific artifact",
    description = "Update and return the artifact"
  )
  @PutMapping(
    path = "/{uuid}",
    consumes = { MediaType.APPLICATION_JSON_VALUE, "application/x-yaml" },
  ...
  public ResponseEntity<Artifact> updateArtifact(
    ...
    return ResponseEntity.ok(
      this.artifactService.updateArtifact(artifactDTO, uuid)
    );
  }
