...
@Validated
@Tag(
  name = "Workflow context API",
  description = "Endpoints related to workflows management in Context"
)
public class WorkflowContextController extends AbstractContextController {
  ...
  public ResponseEntity<Page<Workflow>> getLatestWorkflows(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.getLatestByProjectName(
          filter,
          project,
          pageable
        )
  ...
  public ResponseEntity<Page<Workflow>> getAllWorkflows(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.getByProjectNameAndWorkflowName(
          filter,
          project,
          name,
          pageable
  ...
  public ResponseEntity<Workflow> getWorkflowByUuid(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.getByProjectAndWorkflowAndUuid(
          project,
          name,
          uuid
        )
  ...
  public ResponseEntity<Workflow> getLatestWorkflowByName(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.getLatestByProjectNameAndWorkflowName(
          project,
          name
        )
    );
  ...
  public ResponseEntity<Workflow> createOrUpdateWorkflow(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.createOrUpdateWorkflow(
          project,
          name,
          workflowDTO
        )
  ...
  public ResponseEntity<Workflow> updateUpdateWorkflow(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.updateWorkflow(
          project,
          name,
          uuid,
          workflowDTO
  ...
  public ResponseEntity<Boolean> deleteSpecificWorkflowVersion(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.deleteSpecificWorkflowVersion(
          project,
          name,
          uuid
        )
  ...
  public ResponseEntity<Boolean> deleteWorkflow(
    ...
    return ResponseEntity.ok(
      this.workflowContextService.deleteAllWorkflowVersions(project, name)
    );
  }
}
