...
public class ProjectController {
  ...
  @Operation(
    ...
    description = "Create an project and return"
  )
  @PostMapping(
    value = "",
  ...
  @Operation(
    summary = "Get an project by name",
    description = "Return an project"
  )
  ...
  @Operation(
    ...
    description = "Update and return the project"
  )
  @PutMapping(
    path = "/{name}",
    consumes = { MediaType.APPLICATION_JSON_VALUE, "application/x-yaml" },
  ...
  public ResponseEntity<Project> updateProject(
    ...
    return ResponseEntity.ok(
      this.projectService.updateProject(projectDTO, name)
    );
  }
  ...
  @Operation(
    ...
    description = "Get all project function list"
  )
  @GetMapping(
    path = "/{name}/functions",
    produces = "application/json; charset=UTF-8"
  ...
  @Operation(
    ...
    description = "Get all project workflow list"
  )
  @GetMapping(
    path = "/{name}/workflows",
    produces = "application/json; charset=UTF-8"
  ...
  @Operation(
    ...
    description = "Get all project artifact list"
  )
  @GetMapping(
    path = "/{name}/artifacts",
    produces = "application/json; charset=UTF-8"
  ...
  @Operation(
    ...
    description = "Get all project secrets list"
  )
  @GetMapping(
    path = "/{name}/secrets",
    produces = "application/json; charset=UTF-8"
  ...
  @Operation(
    summary = "Read project secret data",
    description = "Get project secrets data for the specified keys"
  )
  @GetMapping(
    path = "/{name}/secrets/data",
    produces = "application/json; charset=UTF-8"
  )
  public ResponseEntity<Map<String, String>> projectSecretData(
    ...
    return ResponseEntity.ok(
      this.projectService.getProjectSecretData(name, keys)
    );
  }

  @Operation(
    summary = "Store project secret data",
    description = "Store project secrets data"
  )
  @PutMapping(
    path = "/{name}/secrets/data",
    produces = "application/json; charset=UTF-8"
