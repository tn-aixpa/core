...
@Validated
@Tag(
  name = "Workflow base API",
  description = "Endpoints related to workflows management out of the Context"
)
public class WorkflowController {
  ...
  @Operation(
    ...
    description = "Return a list of all workflows"
  )
  ...
  public ResponseEntity<Page<Workflow>> getWorkflows(
    ...
    return ResponseEntity.ok(
      this.workflowService.getWorkflows(filter, pageable)
    );
  }

  @Operation(
    summary = "Create workflow",
    description = "Create an workflow and return"
  )
  @PostMapping(
    value = "",
  ...
  @Operation(
    summary = "Get an workflow by uuid",
    description = "Return an workflow"
  )
  ...
  @Operation(
    summary = "Update specific workflow",
    description = "Update and return the workflow"
  )
  @PutMapping(
    path = "/{uuid}",
    consumes = { MediaType.APPLICATION_JSON_VALUE, "application/x-yaml" },
  ...
  public ResponseEntity<Workflow> updateWorkflow(
    ...
    return ResponseEntity.ok(
      this.workflowService.updateWorkflow(workflowDTO, uuid)
    );
  }
  ...
  public ResponseEntity<List<Run>> workflowRuns(
    @ValidateField @PathVariable String uuid
  ) {
