...
@RuntimeComponent(runtime = HeraPipelineRunSpec.KIND)
public class HeraPipelineLifecycleManager extends RunLifecycleManager<HeraRunSpec, HeraRunStatus, K8sRunnable> {

    HeraPipelineLifecycleManager(HeraRuntime runtime) {
        super(runtime);
    }
}
