package it.smartcommunitylabdhub.commons.utils.jackson;
...
import it.smartcommunitylabdhub.commons.models.base.specs.ConcreteSpecMixin;
...
public class JacksonMapper {
  ...
  static {
    ...
    CUSTOM_OBJECT_MAPPER.configure(
  ...
  public static JavaType extractJavaType(Class<?> clazz) {
    ...
    return CUSTOM_OBJECT_MAPPER
      .getTypeFactory()
      .constructSimpleType(clazz, null);
  }
}
