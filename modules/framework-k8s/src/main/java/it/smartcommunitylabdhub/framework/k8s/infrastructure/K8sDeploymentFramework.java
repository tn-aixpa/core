...
public class K8sDeploymentFramework
  implements Framework<K8sDeploymentRunnable>, InitializingBean {
  ...
  public void execute(K8sDeploymentRunnable runnable) throws CoreException {
    ...
    try {
      ...
      log.info(
        "Deployment created: " +
        Objects.requireNonNull(createdDeployment.getMetadata()).getName()
      );
    } catch (Exception e) {
  ...
  private void logPod(
    ...
    String cName,
    String namespace,
    K8sDeploymentRunnable runnable
  ) {
    try {
