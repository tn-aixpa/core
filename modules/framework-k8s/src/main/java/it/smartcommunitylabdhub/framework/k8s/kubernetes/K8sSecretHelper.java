...
public class K8sSecretHelper {
  ...
  public void deleteSecretKeys(String secretName, Set<String> keys)
    ...
    if (secret != null) {
      ...
      V1Patch patch = new V1Patch(
        mapper.writeValueAsString(Collections.singleton(patchData))
      );
    ...
    if (secret != null) {
      ...
      for (String key : data.keySet()) {
        writeData.put(
          ...
          Base64
            .getEncoder()
            .encodeToString(data.get(key).getBytes(StandardCharsets.UTF_8))
        );
      }
