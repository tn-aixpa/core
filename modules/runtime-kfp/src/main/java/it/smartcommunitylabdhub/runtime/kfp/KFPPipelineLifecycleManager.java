...
@RuntimeComponent(runtime = KFPPipelineRunSpec.KIND)
public class KFPPipelineLifecycleManager extends RunLifecycleManager<KFPRunSpec, KFPRunStatus, K8sRunnable> {

    KFPPipelineLifecycleManager(KFPRuntime runtime) {
        super(runtime);
    }
}
