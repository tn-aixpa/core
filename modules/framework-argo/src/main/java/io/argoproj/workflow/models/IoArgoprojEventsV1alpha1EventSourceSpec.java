...
import io.argoproj.workflow.models.IoArgoprojEventsV1alpha1RedisStreamEventSource;
...
import io.argoproj.workflow.models.IoArgoprojEventsV1alpha1WebhookEventSource;
...
public class IoArgoprojEventsV1alpha1EventSourceSpec {
  ...
  private Map<String, IoArgoprojEventsV1alpha1RedisStreamEventSource> redisStream = null;
  ...
  private Map<String, IoArgoprojEventsV1alpha1WebhookEventSource> webhook = null;
  ...
  **/
  ...
  public IoArgoprojEventsV1alpha1EventSourceSpec putBitbucketItem(String key, IoArgoprojEventsV1alpha1BitbucketEventSource bitbucketItem) {
    if (this.bitbucket == null) {
      this.bitbucket = new HashMap<String, IoArgoprojEventsV1alpha1BitbucketEventSource>();
    }
  ...
  **/
  ...
  public IoArgoprojEventsV1alpha1EventSourceSpec putBitbucketserverItem(String key, IoArgoprojEventsV1alpha1BitbucketServerEventSource bitbucketserverItem) {
    if (this.bitbucketserver == null) {
      this.bitbucketserver = new HashMap<String, IoArgoprojEventsV1alpha1BitbucketServerEventSource>();
    }
  ...
  **/
  ...
  public IoArgoprojEventsV1alpha1EventSourceSpec redisStream(Map<String, IoArgoprojEventsV1alpha1RedisStreamEventSource> redisStream) {
  ...
  public IoArgoprojEventsV1alpha1EventSourceSpec putRedisStreamItem(String key, IoArgoprojEventsV1alpha1RedisStreamEventSource redisStreamItem) {
    if (this.redisStream == null) {
      this.redisStream = new HashMap<String, IoArgoprojEventsV1alpha1RedisStreamEventSource>();
    }
  ...
  **/
  ...
  public void setRedisStream(Map<String, IoArgoprojEventsV1alpha1RedisStreamEventSource> redisStream) {
    this.redisStream = redisStream;
  }
  ...
  **/
  ...
  public IoArgoprojEventsV1alpha1EventSourceSpec webhook(Map<String, IoArgoprojEventsV1alpha1WebhookEventSource> webhook) {
  ...
  public IoArgoprojEventsV1alpha1EventSourceSpec putWebhookItem(String key, IoArgoprojEventsV1alpha1WebhookEventSource webhookItem) {
    if (this.webhook == null) {
      this.webhook = new HashMap<String, IoArgoprojEventsV1alpha1WebhookEventSource>();
    }
  ...
  **/
  ...
  public void setWebhook(Map<String, IoArgoprojEventsV1alpha1WebhookEventSource> webhook) {
    this.webhook = webhook;
  }
