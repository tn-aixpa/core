...
public class Link {
  ...
  **/
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "\"workflow\", \"pod\", \"pod-logs\", \"event-source-logs\", \"sensor-logs\", \"workflow-list\" or \"chat\"")
   ...
   * @return url
  **/
  @ApiModelProperty(required = true, value = "The URL. Can contain \"${metadata.namespace}\", \"${metadata.name}\", \"${status.startedAt}\", \"${status.finishedAt}\" or any other element in workflow yaml, e.g. \"${metadata.annotations.userDefinedKey}\"")
