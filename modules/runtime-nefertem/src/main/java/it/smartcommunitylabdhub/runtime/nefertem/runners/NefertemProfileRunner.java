...
public class NefertemProfileRunner {

    private final String image;

    private final Map<String, String> secretData;

    public NefertemProfileRunner(String image, Map<String, String> secretData) {
        this.image = image;
    ...
    public K8sJobRunnable produce(Run run) {
        ...
        NefertemProfileTaskSpec taskSpec = runSpec.getTaskProfileSpec();
        if (taskSpec == null) {
