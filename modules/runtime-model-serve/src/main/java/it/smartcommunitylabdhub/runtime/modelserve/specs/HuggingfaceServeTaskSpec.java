...
import it.smartcommunitylabdhub.runtime.modelserve.models.HuggingfaceBackend;
import it.smartcommunitylabdhub.runtime.modelserve.models.HuggingfaceDType;
import it.smartcommunitylabdhub.runtime.modelserve.models.HuggingfaceTask;
...
public class HuggingfaceServeTaskSpec extends ModelServeServeTaskSpec {
    ...
    public static final String KIND = "huggingfaceserve+serve";
    ...
    @Schema(title = "fields.huggingface.tokenizerrevision.title", description = "fields.huggingface.tokenizerrevision.description")
    ...
    @Schema(title = "fields.huggingface.disablelowercase.title", description = "fields.huggingface.disablelowercase.description")
    ...
    @Schema(title = "fields.huggingface.disablespecialtokens.title", description = "fields.huggingface.disablespecialtokens.description")
    ...
    @Schema(title = "fields.huggingface.trustremotecode.title", description = "fields.huggingface.trustremotecode.description")
    private Boolean trustRemoteCode;

    // the tensor input names passed to the model
    @JsonProperty("tensor_input_names")
    @Schema(title = "fields.huggingface.tensorinputnames.title", description = "fields.huggingface.tensorinputnames.description")
    private List<String> tensorInputNames;

    // Return token type ids
    @JsonProperty("return_token_type_ids")
    @Schema(title = "fields.huggingface.returntokentypeids.title", description = "fields.huggingface.returntokentypeids.description")
    private Boolean returnTokenTypeIds;

    // Return all probabilities
    @JsonProperty("return_probabilities")
    @Schema(title = "fields.huggingface.returnprobabilities.title", description = "fields.huggingface.returnprobabilities.description")
    private Boolean returnProbabilities;

    // Disable logging requests
    @JsonProperty("disable_log_requests")
    @Schema(title = "fields.huggingface.disablelogrequests.title", description = "fields.huggingface.disablelogrequests.description")
