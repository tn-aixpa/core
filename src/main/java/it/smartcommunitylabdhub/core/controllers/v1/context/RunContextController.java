...
public class RunContextController implements ContextController {
    ...
    public ResponseEntity<Run> createRun(
            @ValidateField @PathVariable String project,
            @Valid @RequestBody Run RunDTO) {
        return ResponseEntity.ok(
                this.RunContextService.createRun(project, RunDTO));
    }

    @Operation(summary = "Retrive only the latest version of all Run",
    ...
    @Operation(summary = "Retrieve a specific Run given the Run uuid",
    ...
    public ResponseEntity<Run> updateUpdateRun(
        ...
        return ResponseEntity
                .ok(this.RunContextService.updateRun(
                        project, uuid, RunDTO));
    }

    @Operation(summary = "Delete a specific Run version",
    ...
    public ResponseEntity<Boolean> deleteSpecificRunVersion(
        ...
        return ResponseEntity
                .ok(this.RunContextService.deleteSpecificRunVersion(
                        project, uuid));
    }
