...
public class TaskController {
    ...
    public ResponseEntity<XTask> getTask(
    ...
    public ResponseEntity<List<XTask>> getTasks(Pageable pageable) {
    ...
    public ResponseEntity<XTask> createTask(@Valid @RequestBody XTask taskDTO) {
    ...
    @PutMapping(path = "/{uuid}", consumes = {MediaType.APPLICATION_JSON_VALUE,
            "application/x-yaml"}, produces = "application/json; charset=UTF-8")
    public ResponseEntity<XTask> updateTask(@Valid @RequestBody XTask functionDTO,
